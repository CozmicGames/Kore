...
fun lengthSquared(v: Vector4) = lengthSquared(v.x, v.y, v.z, v.w)
...
fun length(v: Vector4) = length(v.x, v.y, v.z, v.w)
...
fun distanceSquared(v0: Vector4, v1: Vector4) = distanceSquared(v0.x, v0.y, v0.z, v0.w, v1.x, v1.y, v1.z, v1.w)
...
fun distance(v0: Vector4, v1: Vector4) = distance(v0.x, v0.y, v0.z, v0.w, v1.x, v1.y, v1.z, v1.w)
...
fun plus(a: Vector4, b: Vector4, dest: Vector4 = Vector4()) = plus(a.x, a.y, a.z, a.w, b.x, b.y, b.z, b.w, dest)
...
fun plus(x0: Float, y0: Float, z0: Float, w0: Float, x1: Float, y1: Float, z1: Float, w1: Float, dest: Vector4 = Vector4()) = plus(x0, y0, z0, w0, x1, y1, z1, w1) { x, y, z, w -> dest.set(x, y, z, w) }
...
fun sub(a: Vector4, b: Vector4, dest: Vector4 = Vector4()) = sub(a.x, a.y, a.z, a.w, b.x, b.y, b.z, b.w, dest)
...
fun sub(x0: Float, y0: Float, z0: Float, w0: Float, x1: Float, y1: Float, z1: Float, w1: Float, dest: Vector4 = Vector4()) = sub(x0, y0, z0, w0, x1, y1, z1, w1) { x, y, z, w -> dest.set(x, y, z, w) }
...
fun times(a: Vector4, b: Vector4, dest: Vector4 = Vector4()) = times(a.x, a.y, a.z, a.w, b.x, b.y, b.z, b.w, dest)
...
fun times(x0: Float, y0: Float, z0: Float, w0: Float, x1: Float, y1: Float, z1: Float, w1: Float, dest: Vector4 = Vector4()) = times(x0, y0, z0, w0, x1, y1, z1, w1) { x, y, z, w -> dest.set(x, y, z, w) }
...
fun div(a: Vector4, b: Vector4, dest: Vector4 = Vector4()) = div(a.x, a.y, a.z, a.w, b.x, b.y, b.z, b.w, dest)
...
fun div(x0: Float, y0: Float, z0: Float, w0: Float, x1: Float, y1: Float, z1: Float, w1: Float, dest: Vector4 = Vector4()) = div(x0, y0, z0, w0, x1, y1, z1, w1) { x, y, z, w -> dest.set(x, y, z, w) }
