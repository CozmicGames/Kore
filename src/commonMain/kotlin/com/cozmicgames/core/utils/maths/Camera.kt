...
import com.cozmicgames.core.graphics.safeHeight
import com.cozmicgames.core.graphics.safeWidth
...
class OrthographicCamera(var width: Int, var height: Int) : Camera() {
    ...
    override fun update() {
        ...
        projection.setToOrtho(-zoom * halfWidth, zoom * halfWidth, -zoom * halfHeight, zoom * halfHeight, 0.0f, 1.0f)
