package com.cozmicgames.core.utils.extensions

import com.cozmicgames.core.utils.ByteArrayBuilder
import com.cozmicgames.core.utils.hashCodeOf
...
fun write16(index: Int, value: Int, access: (Int, Byte) -> Unit) {
    ...
    write8(index + 1, ((value and 0xFF00) ushr 8), access)
}

fun write32(index: Int, value: Int, access: (Int, Byte) -> Unit) {
    write16(index, (value and 0xFFFF), access)
    write16(index + 2, ((value and 0xFFFF0000.toInt()) ushr 16), access)
}
