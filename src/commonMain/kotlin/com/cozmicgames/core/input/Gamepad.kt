...
import com.cozmicgames.core.utils.extensions.element
...
class Gamepad(val id: Int) {
    ...
    private val buttons = BooleanArray(GamepadButtons.Companion.count)
    private val buttonStates = BooleanArray(GamepadButtons.Companion.count)
    private val buttonsJustDown = BooleanArray(GamepadButtons.Companion.count)
    private val buttonsJustUp = BooleanArray(GamepadButtons.Companion.count)
