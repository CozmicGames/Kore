...
import com.cozmicgames.core.utils.Context
...
object Kore {
     ...
     */
    val platformType get() = platform?.type ?: throw IllegalStateException("Kore is not initialized yet.")
...
/**
 * The info for the application.
 * @see [Configuration]
 */
val Kore.applicationInfo by Kore.context.injector<ApplicationInfo>()
