...
interface MemoryAccess {
    ...
    /**
     * Puts the specified float [value] at the specified [address] at the specified [position].
     *
     * @param address The address of the memory to set.
     * @param position The position to set the value at.
     * @param value The value to set.
     */
    fun putFloat(address: Long, position: Int, value: Float)

    /**
     * Gets the float value at the specified [address] at the specified [position].
     *
     * @param address The address of the memory to get.
     * @param position The position to get the value at.
     *
     * @return The float value at the specified [address] at the specified [position].
     */
    fun getFloat(address: Long, position: Int): Float

    /**
     * Copies the bytes from the specified [from] byte array at the specified [fromOffset] to the specified [toAddress] at the specified [toOffset] for the specified [length].
     *
     * @param from The byte array to copy from.
     * @param fromOffset The offset in the byte array to copy from.
     * @param toAddress The address of the memory to copy to.
     * @param toOffset The offset in the memory to copy to.
     * @param length The length to copy.
     */
    fun copyBytes(from: ByteArray, fromOffset: Int, toAddress: Long, toOffset: Int, length: Int)

    /**
     * Copies the shorts from the specified [from] short array at the specified [fromOffset] to the specified [toAddress] at the specified [toOffset] for the specified [length].
     *
     * @param from The short array to copy from.
     * @param fromOffset The offset in the short array to copy from.
     * @param toAddress The address of the memory to copy to.
     * @param toOffset The offset in the memory to copy to.
     * @param length The length to copy.
     */
    fun copyShorts(from: ShortArray, fromOffset: Int, toAddress: Long, toOffset: Int, length: Int)

    /**
     * Copies the integers from the specified [from] integer array at the specified [fromOffset] to the specified [toAddress] at the specified [toOffset] for the specified [length].
     *
     * @param from The integer array to copy from.
     * @param fromOffset The offset in the integer array to copy from.
     * @param toAddress The address of the memory to copy to.
     * @param toOffset The offset in the memory to copy to.
     * @param length The length to copy.
     */
    fun copyInts(from: IntArray, fromOffset: Int, toAddress: Long, toOffset: Int, length: Int)

    /**
     * Copies the longs from the specified [from] long array at the specified [fromOffset] to the specified [toAddress] at the specified [toOffset] for the specified [length].
     *
     * @param from The long array to copy from.
     * @param fromOffset The offset in the long array to copy from.
     * @param toAddress The address of the memory to copy to.
     * @param toOffset The offset in the memory to copy to.
     * @param length The length to copy.
     */
    fun copyLongs(from: LongArray, fromOffset: Int, toAddress: Long, toOffset: Int, length: Int)

    /**
     * Copies the floats from the specified [from] float array at the specified [fromOffset] to the specified [toAddress] at the specified [toOffset] for the specified [length].
     *
     * @param from The float array to copy from.
     * @param fromOffset The offset in the float array to copy from.
     * @param toAddress The address of the memory to copy to.
     * @param toOffset The offset in the memory to copy to.
     * @param length The length to copy.
     */
    fun copyFloats(from: FloatArray, fromOffset: Int, toAddress: Long, toOffset: Int, length: Int)
}
