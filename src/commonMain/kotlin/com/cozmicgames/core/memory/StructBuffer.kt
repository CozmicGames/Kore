 ...
 */
class StructBuffer<T : Struct>(size: Int, private val allocator: MemoryAllocator, private val supplier: () -> T) : Iterable<T>, Disposable {
    /**
     ...
     */
    var memory = allocator.alloc(size * structSize)
        private set
    ...
    fun resize(size: Int) {
        ...
        val newMemory = allocator.alloc(structSize * size)
