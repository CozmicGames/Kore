...
abstract class Struct() : Disposable {
     ...
     */
    constructor(allocator: MemoryAllocator) : this() {
     ...
     */
    constructor(isStackAllocated: Boolean) : this(if (isStackAllocated) StackMemoryAllocator else DefaultMemoryAllocator)
