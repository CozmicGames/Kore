...
import com.cozmicgames.core.graphics.toByteArray
...
class DesktopInput : InputProcessor, Input, Updateable, Disposable {
    ...
    private var keys = BooleanArray(Keys.entries.size) { false }
    private var keyStates = BooleanArray(Keys.entries.size) { false }
    private var keysJustDown = BooleanArray(Keys.entries.size) { false }
    private var keysJustUp = BooleanArray(Keys.entries.size) { false }

    private var buttons = BooleanArray(MouseButtons.entries.size) { false }
    private var buttonStates = BooleanArray(MouseButtons.entries.size) { false }
    private var buttonsJustDown = BooleanArray(MouseButtons.entries.size) { false }
    private var buttonsJustUp = BooleanArray(MouseButtons.entries.size) { false }
